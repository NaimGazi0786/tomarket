...
{Style.RESET_ALL}
    ...
    additional_text = f"""
{Fore.GREEN + Style.BRIGHT}Author - NaimGazi TG @BLUMSCRIPTS{Style.RESET_ALL}
{Fore.WHITE}Telegram - https://t.me/GN_SCRIPTS
Youtube  - https://www.youtube.com/@GyaaniNaim
{Style.RESET_ALL}
{Fore.YELLOW + Style.BRIGHT}IF YOU FACE ANY SCRIPT JOIN @GN_SCRIPTS{Style.RESET_ALL}
    """
    
    # Clear the terminal before displaying the banner
...
if __name__ == '__main__':
    display_banner()  # Display the banner and additional text before starting the main logic
    try:
        seed = Seed()
